package com.minecraft.frizz.arcade.manager;

import com.minecraft.frizz.arcade.Arcade;
import com.minecraft.frizz.arcade.api.item.ItemBuilder;
import com.minecraft.frizz.arcade.game.scheduler.GameRunnable;
import com.minecraft.frizz.arcade.game.stage.GameStage;
import com.minecraft.frizz.arcade.manager.client.ClientManager;
import com.minecraft.frizz.arcade.scheduler.ServerRunnable;
import com.minecraft.frizz.arcade.utils.ClassGetter;
...
public class Manager {
    ...
    public Manager(Arcade plugin) {
        this.plugin = plugin;

        this.spawnLocation = new Location(Bukkit.getWorld("world"), 0.5, 61.0, 0.5);
        ...
        ClassGetter.loadPackageByFile(plugin.getFile(), "com.minecraft.frizz.arcade.listeners").stream()
