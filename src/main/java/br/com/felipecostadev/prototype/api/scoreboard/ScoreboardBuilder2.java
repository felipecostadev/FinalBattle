...
import br.com.felipecostadev.prototype.api.scoreboard.row.ScoreboardRow;
...
public abstract class ScoreboardBuilder2 {

    private Scoreboard scoreboard;
    private Objective objective;

    public ScoreboardBuilder2(Player player) {
